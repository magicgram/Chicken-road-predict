        ...
        <div className="flex items-start space-x-4">
            ...
            <div className="flex-grow">
                ...
                <div className="mt-2 flex items-center justify-between bg-black/40 p-2 pr-3 rounded-lg border border-white/20">
                    <span className="font-mono text-sm text-purple-300 break-all">{postbackUrl || t('postbackGuide.loadingUrl')}</span>
                    <button 
                        onClick={handleCopy}
                        className="p-2 ml-2 rounded-md hover:bg-white/10 transition-colors focus:outline-none focus:ring-2 focus:ring-purple-400 flex-shrink-0"
                        aria-label="Copy URL"
    ...
    return (
        <div className="w-full max-w-2xl mx-auto p-8 dark-card mb-8">
            <div className="text-center mb-10">
                ...
                <p className="text-gray-300">{t('postbackGuide.subtitle')}</p>
            </div>
