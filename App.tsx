        ...
        <div className={isPredictorPageActive ? '' : 'page-container'}>
            ...
            <header className="absolute top-0 left-0 right-0 p-4 flex justify-between items-center text-white z-20">
                {isPredictorPageActive && user ? (
                     <div className="flex items-start gap-3 text-shadow-lg">
                        <span className="header-dot"></span>
                        <div className="flex flex-col">
                            <h1 className="font-bold text-[1.2rem] leading-tight sm:text-lg flex flex-col text-white tracking-wider" style={{textShadow: '1px 1px 3px rgba(0,0,0,0.6)'}}>
                                <span>CHICKEN ROAD</span>
                                <span>PREDICTOR</span>
                            </h1>
                            <div className="text-xs text-gray-300 mt-2 flex items-center gap-4">
